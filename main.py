...
class Slam(object):
    ...
    def matchFrame(self, frame1, frame2):
        ...
        _, R, t, inliers = cv2.recoverPose(E, frame1_pts_un, frame2_pts_un, self.K)
        pose = np.eye(4)
        pose[0:3, 0:3] = R
    ...
    def processFrame(self, image):
        ...
        points3d, err = helper.triangulate(P1, prev_frame.keypoints[match_idx1], P2, curr_frame.keypoints[match_idx2])
